...
CREATE TABLE `brand_names` (
  `id` int(11) NOT NULL,
  `tumbler` varchar(255) NOT NULL,
  `eyeglasses` varchar(255) NOT NULL,
  `fastfoodchain` varchar(255) NOT NULL,
...
INSERT INTO `brand_names` (`id`, `tumbler`, `eyeglasses`, `fastfoodchain`, `laptop`) VALUES
(1, 'AquaFlask', 'Sunnies Studios', 'Jollibee', 'Acer'),
(2, 'HydroFlask', 'EO', 'McDonalds', 'HP');
